...
* Slides are available on [Lehigh's Research Computing site](https://researchcomputing.lehigh.edu/training), [Wordpress](https://wordpress.lehigh.edu/jsm4/data-visualization/programming-in-r/), and Github ([slides](https://jeremymack-lu.github.io/rprog/) and [raw code](https://github.com/jeremymack-LU/rprog))
 ...
 * [**Topic 1:**](<https://jeremymack-lu.github.io/rprog/#4>) What is R? Why use it?
 
 * [**Topic 2:**](<https://jeremymack-lu.github.io/rprog/#10>) What is RStudio? Why use it?
 
 * [**Topic 3:**](<https://jeremymack-lu.github.io/rprog/#16>) Getting started with R and RStudio
 
 * [**Topic 4:**](<https://jeremymack-lu.github.io/rprog/#29>) Objects and Functions
 
 * [**Topic 5:**](<https://jeremymack-lu.github.io/rprog/#56>) Data and Data Wrangling
 
 * [**Topic 6:**](<https://jeremymack-lu.github.io/rprog/#91>) Plotting
 
 * [**Topic 7:**](<https://jeremymack-lu.github.io/rprog/#112>) Other things to do with R
...
- **Very active development community**
    ...
    + User contributed packages <br/> (> 15,000)
    {{content}}
...
* When you download and install R for the first time, you are installing the [base R](<https://rstudio.com/resources/cheatsheets/>) - only functions written by the original authors of the R language.
