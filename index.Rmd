 ...
 * [**Topic 7:**](<https://jeremymack-lu.github.io/rprog/#200>) Other things to do with R
...
- Developed by Ross Ihaka and Robert Gentleman `r lubridate::year(Sys.Date())-1993` years ago; it is now developed by a core team supported by the R Foundation.
...
- **Very active development community**
    ...
    + User contributed packages <br/> (> 17,000)
    {{content}}
